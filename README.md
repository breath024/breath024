...
**저장소 대부분이 비공개라 아래 잔디에는 거의 안 보입니다.** 회사 코드거나
개인 데이터가 섞여 있어서입니다. 실제로 만든 건 이쪽입니다.

---

### AI 시스템

**COMET** · 2026-03 ~ · Python · 10,300줄
...
**QALens** · 2026-08 · Python · 2,700줄
파일 종류를 판별해 정적 분석과 브라우저 런타임 검사를 같이 돌리는 QA CLI.

**ContentForge** · 2026-06 ~ · Python · 2,200줄
주제 한 줄을 넣으면 카드뉴스를 만들어내는 앱.

**에이전트 관리 콘솔** · 2026-06 ~ · Python · 3,100줄
...
**stock-bot** · 2026-05 ~ · Python
국내 주식 자동매매와 가상매매.

### 웹

**Only Money** · 2026-06 ~ · 단일 HTML · 10,600줄 — 투자 대시보드
**중국어 SRS** · 2026-05 ~ · 단일 HTML · 5,100줄 — 회화 중심 학습앱, 데이터 팩 분리
**AURA** · 2026-06 · Three.js — 스크롤에 따라 카메라가 전진하는 3D 데모
